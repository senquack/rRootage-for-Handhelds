...
BulletMLParserXercesSAXHandler::BulletMLParserXercesSAXHandler (BulletMLParserXerces * parser):parser_ (parser),
   curNode_
   (0)
{
}
...
void
BulletMLParserXercesSAXHandler::characters (const XMLCh * const chars,
                                            const unsigned int length)
{
...
void
BulletMLParserXercesSAXHandler::startElement (const XMLCh * const name,
                                              AttributeList & attributes)
{
   ...
   if (curNode_ != 0)
      curNode_->addChild (node);
   curNode_ = node;
}

void
BulletMLParserXercesSAXHandler::endElement (const XMLCh * const)
{
