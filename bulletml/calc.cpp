...
// CalcFormula* f(double d) { return formulas[(int)d]; }
   CalcFormula *f (float d)
   {
      return formulas[(int) d];
   }
...
#line 62 "calc.yy"
      {
         (yyval) = formulas.size ();
         formulas.push_back (new
                             CalcFormula (new
                                          CalcNumber ((yyvsp[(1) - (1)]))));
      }
      break;
...
#line 78 "calc.yy"
      {
         (yyval) = formulas.size ();
         formulas.push_back (new
                             CalcFormula (f ((yyvsp[(1) - (3)])), op_add,
                                          f ((yyvsp[(3) - (3)]))));
      }
      break;
...
#line 82 "calc.yy"
      {
         (yyval) = formulas.size ();
         formulas.push_back (new
                             CalcFormula (f ((yyvsp[(1) - (3)])), op_sub,
                                          f ((yyvsp[(3) - (3)]))));
      }
      break;
...
#line 86 "calc.yy"
      {
         (yyval) = formulas.size ();
         formulas.push_back (new
                             CalcFormula (f ((yyvsp[(1) - (3)])), op_mul,
                                          f ((yyvsp[(3) - (3)]))));
      }
      break;
...
#line 90 "calc.yy"
      {
         (yyval) = formulas.size ();
         formulas.push_back (new
                             CalcFormula (f ((yyvsp[(1) - (3)])), op_div,
                                          f ((yyvsp[(3) - (3)]))));
      }
      break;
