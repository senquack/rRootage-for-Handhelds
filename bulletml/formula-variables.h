...
template < typename Val_ > class Random:public AbstractNumber < Val_ >
{
 public:
...
template < typename Val_ > class Rank:public AbstractNumber < Val_ > {
 public:
   DECLSPEC virtual Val_ value ()const
   {
...
template < typename Val_ > class Param:public AbstractNumber < Val_ > {
 public:
