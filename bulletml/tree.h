 ...
 * それの息子以下の世代は全て破壊される。
 */
template < class C_ > class TreeNode {
 public:
 ...
 public:
   ...
   DECLSPEC ChildIterator childBegin ()
   {
      return children_.begin ();
   }
   DECLSPEC ChildIterator childEnd ()
   {
      return children_.end ();
   }
   DECLSPEC size_t childSize ()
   {
      return children_.size ();
   }
   DECLSPEC ConstChildIterator childBegin () const
   {
      return children_.begin ();
   }
   DECLSPEC ConstChildIterator childEnd () const
   {
      return children_.end ();
   }
   DECLSPEC C_ *getParent ()
   {
      return parent_;
   }
...
template < class C_ > TreeNode < C_ >::~TreeNode ()
{
   if (releaseDuty_) {
      ChildIterator ite;
