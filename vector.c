...
float
vctInnerProduct (Vector * v1, Vector * v2)
{
   return (float) v1->x * v2->x + (float) v1->y * v2->y;
}

Vector
vctGetElement (Vector * v1, Vector * v2)
{
   Vector ans;
...
int
vctCheckSide (Vector * checkPos, Vector * pos1, Vector * pos2)
{
